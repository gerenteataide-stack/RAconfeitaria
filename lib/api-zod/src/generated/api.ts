...
export const GetCustomerHistoryResponse = zod.object({
  ...
  "paymentMethod": zod.union([zod.literal('pix'),zod.literal('cash'),zod.literal('debit_card'),zod.literal('credit_card'),zod.literal(null)]).nullish(),
...
export const CreateOrderBody = zod.object({
  ...
  "paymentMethod": zod.enum(['pix', 'cash', 'debit_card', 'credit_card']).optional(),
  "deliveryType": zod.enum(['pickup', 'delivery']),
